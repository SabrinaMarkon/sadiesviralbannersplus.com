 ...
 * @license LICENSE.md
 *
 * @param $settings Admin settings for the website.
 *
 */
...
class SendEmails
{
    ...
    public static function getMails(array $settings): void
    {
                ...
                if ($members) {
                    ...
                    foreach ($members as $member) {
                        ...
                        if ($senderuserid === 'admin') {
                            ...
                            $sendsiteemail->sendEmail($settings['adminemail'], $adminemail, $subject, $html, $settings['sitename'], $settings['adminemail'], $htmlheader);
                        }
                    }
                }
...
$mail = SendEmails::getMails($settings);
