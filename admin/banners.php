...
<div class="container">
			...
			<?php
				...
				<form action="/admin/banners" method="post" accept-charset="utf-8" class="form" role="form">
			...
			<h1 class="ja-bottompadding ja-toppadding mb-4">All Member Banners</h1>
					...
					<table class="table table-bordered table-striped table-hover text-center table-sm">
						...
						if (!$ads) {
							...
							foreach ($ads as $ad) {
								...
								?>
								<tr>
									<form action="/admin/banners/<?php echo $ad['id']; ?>" method="post" accept-charset="utf-8" class="form" role="form">
