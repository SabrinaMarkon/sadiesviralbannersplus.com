...
class Setting
{
    ...
    public function saveSettings(string $adminuser, string $adminpass)
    {
        ...
        $newadclickstogetbannerspaidad = $_POST['adclickstogetbannerspaidad'];
