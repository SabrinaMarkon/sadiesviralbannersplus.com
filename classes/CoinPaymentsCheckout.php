...
class CoinPaymentsCheckout extends PaymentGateway
{
    ...
    protected function _payButton()
    {
        ...
        $paybutton = '
            ...
            <input type="hidden" name="merchant" value="' . $this->admincoinpayments . '">
            <input type="hidden" name="item_name" value="' . $this->sitename . ' - ' . $this->itemname . '">
            <input type="hidden" name="currency" value="ETH">
            <input type="hidden" name="currency1" value="ETH">
            <input type="hidden" name="currency2" value="<?php echo $coincode ?>">
            <input type="hidden" name="amountf" value="' . $this->price . '">
            <input type="hidden" name="want_shipping" value="0">
            <input type="hidden" name="success_url" value="' . $this->domain . '/thankyou">
            <input type="hidden" name="cancel_url" value="' . $this->domain . '">
            <input type="hidden" name="ipn_url" value="' . $this->domain . '/ipn/coinpayments">
    ...
    protected function _ipn()
    {
        ...
        $this->api->Setup($private_key, $public_key);
