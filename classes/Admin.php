...
class Admin
{
	...
	public function adminLogin(string $adminuser, string $adminpass)
	{
	...
	public function forgotLogin(string $sitename, string $domain, string $adminemail, string $adminuser, string $adminpass)
	{
	...
	public function getGravatar(string $adminemail)
	{
