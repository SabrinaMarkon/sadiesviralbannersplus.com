...
<div class="container">
    ...
    if (empty($oneblankad)) {
        ...
        echo "<div class=\"ja-bottompadding ja-topadding mb-5\">You have no paid banners available. Please purchase one below!</div>";
        //TODO: PAYPAL BUTTON!!!
    ...
    <h1 class="ja-bottompadding ja-toppadding">Your Banners</h1>
    ...
    if (empty($activeads)) {
        ...
        echo "<div class=\"ja-bottompadding ja-topadding mb-5\">You have no banners yet.</div>";
    } else {
