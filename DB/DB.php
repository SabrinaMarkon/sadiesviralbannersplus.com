...
`prodownlineupgradestogetbonusslotsonproreferralpages` integer unsigned not null default '8',
`prodownlineupgradeswhichbonusslotsonproreferralpages` varchar(32) not null default '4',
`prodownlineupgradestogetbonusslotsongoldreferralpages` integer unsigned not null default '0',
`prodownlineupgradeswhichbonusslotsongoldreferralpages` varchar(32) not null default '',
...
`golddownlineupgradestogetbonusslotsonproreferralpages` integer unsigned not null default '8',
`golddownlineupgradeswhichbonusslotsonproreferralpages` varchar(32) not null default '4',
`golddownlineupgradestogetbonusslotsongoldreferralpages` integer unsigned not null default '0',
`golddownlineupgradeswhichbonusslotsongoldreferralpages` varchar(32) not null default '',
...
viralbannerloginclicks integer unsigned not null default '0'
) ENGINE=MyISAM DEFAULT CHARSET=latin1;
